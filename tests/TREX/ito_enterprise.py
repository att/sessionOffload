...
class Prof1():
    ...
    def create_profile(self,size,loop,mss):
        ...
        # template
        temp_c = ASTFTCPClientTemplate(program=prog_c,  ip_gen=ip_gen, cps=100)
        ...
        profile = ASTFProfile(default_ip_gen=ip_gen, cap_list=[
            ASTFCapInfo(file="../avl/delay_10_http_browsing_0.pcap", cps=500.00, port=8082),
            ASTFCapInfo(file="../avl/delay_10_http_get_0.pcap", cps=300.00,port=8080),
            ASTFCapInfo(file="../avl/delay_10_http_post_0.pcap", cps=404.52,port=8081),
            ASTFCapInfo(file="../avl/delay_10_https_0.pcap", cps=250.00),
            ASTFCapInfo(file="../avl/delay_10_exchange_0.pcap", cps=253.81),
            ASTFCapInfo(file="../avl/delay_10_mail_pop_0.pcap", cps=20.0),
            ASTFCapInfo(file="../avl/delay_10_oracle_0.pcap", cps=100.00),
            ASTFCapInfo(file="../avl/delay_10_smtp_0.pcap", cps=7.3369),
            ASTFCapInfo(file="../avl/delay_10_dns_0.pcap", cps=5.00),
            ASTFCapInfo(file="../avl/delay_10_citrix_0.pcap", cps=200)
            ], templates=template, default_c_glob_info=info, default_s_glob_info=info)
